...
class LocalEnhancer(nn.Module):
    def __init__(self, input_nc, output_nc, ngf=32, n_downsample_global=3, n_blocks_global=9, 
        ...
        for n in range(1, n_local_enhancers + 1):
            ...
            setattr(self, 'spade_' + str(n) + '_head_0', SPADEResnetBlock(8 * ngf_global, 4 * ngf_global, input_nc_by_2))
            ...
            setattr(self, 'spade_' + str(n) + '_up_0', SPADEResnetBlock(4 * ngf_global, 4 * ngf_global, input_nc_by_2))
