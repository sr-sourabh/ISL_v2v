...
class LocalEnhancer(nn.Module):
    def __init__(self, input_nc, output_nc, ngf=32, n_downsample_global=3, n_blocks_global=9, 
        ...
        for n in range(1, n_local_enhancers + 1):
            ...
            setattr(self, 'spade_' + str(n) + '_fc', nn.Conv2d(input_nc_by_2, 8 * ngf_global, 3, padding=1))
            setattr(self, 'spade_' + str(n) + '_head_0', SPADEResnetBlock(8 * ngf_global, 8 * ngf_global, input_nc_by_2))
            setattr(self, 'spade_' + str(n) + '_G_middle_0', SPADEResnetBlock(8 * ngf_global, 8 * ngf_global, input_nc_by_2))
            setattr(self, 'spade_' + str(n) + '_G_middle_1', SPADEResnetBlock(8 * ngf_global, 8 * ngf_global, input_nc_by_2))
            setattr(self, 'spade_' + str(n) + '_G_middle_2',SPADEResnetBlock(8 * ngf_global, 8 * ngf_global, input_nc_by_2))
            setattr(self, 'spade_' + str(n) + '_up_0', SPADEResnetBlock(8 * ngf_global, 6 * ngf_global, input_nc_by_2))
            setattr(self, 'spade_' + str(n) + '_up_1', SPADEResnetBlock(6 * ngf_global, 4 * ngf_global, input_nc_by_2))
